...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/hinduja.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/hinduja.png" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Roboto:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,700&display=swap" rel="stylesheet">
    ...
    <!-- hospital shared styles (tokens, typography, shared components) -->
    <link rel="stylesheet" href="assets/css/hinduja-shared.css" />
</head>
